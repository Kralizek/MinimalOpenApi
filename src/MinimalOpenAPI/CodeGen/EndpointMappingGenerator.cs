...
internal static class EndpointMappingGenerator
{
        ...
        SchemaDirectionalityAnalysis directionality)
    {
        ...
        var lambdaParams = BuildLambdaParams(operation, handlerClass, contractsNs, directionality, inlineResolver);
        ...
        for (var i = 0; i < responses.Count; i++)
        {
            ...
            var responseTypeName = GetMetadataResponseTypeName(response, contractsNs, directionality, inlineResolver);
